...
#                                     for _ in range(flags.controlnet_image_count):
        ...
        ctrls += ip_ctrls
        ctrls += [inswapper_enabled, inswapper_source_image, inswapper_source_image_indicies, inswapper_target_image_indicies, ins_s_ins, ins_t_ins, ins_s_ims]
